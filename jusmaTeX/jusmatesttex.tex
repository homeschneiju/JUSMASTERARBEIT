...
\subsection{Expert-based variable selection}
...
The data received by NAGEL for use in this coursework was supplied in .csv-format and included 472,137 observations between 17/09/2015 and 31/12/2016 for the following 30 variables:
(TABELLE SPALTENBESCHREIBUNG)
\\
A first glance at the raw data revealed that the variable "gewicht" (weight) had 49 missing values, there are 5,525 different senders and there are 15,576 different recipients.\\
