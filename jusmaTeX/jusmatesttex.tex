...
In order to iteratively model time series data, \citep{Box.1976} proposed a method to identify suitable parameters - AR, MA and differencing - of an ARIMA model. It consists of the following four steps: \\
1. Visual identification of model parameter through ACF for MA- and PACF for AR-parameters.

HIER BOX-JENKINS METHODE NACH WÜRZBUEGRER BUCH \citep{Falk.2012}
